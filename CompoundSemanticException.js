...
define(["dojo/_base/declare", "./SemanticException", "ppwcode-util-oddsAndEnds/js"],
  function(declare, SemanticException, js) {
    ...
    var CompoundSemanticException = declare([SemanticException], {
      ...
      invars: [
        ...
        function() {return js.typeOf(this.children) === "array";},
        // All children are SemanticExceptions, and not Compound
        function() {
          return this.children.every(function(c) {
            return c.isInstanceOf(SemanticException) &&
                   !c.isInstanceOf(CompoundSemanticException);
          });
        }
        // TODO no duplicates
      ],
      ...
      add: function(/*SemanticException?*/ se) {
        ...
        if (se && !self.closed) {
          if (se.isInstanceOf(CompoundSemanticException)) {
            ...
            se.children.forEach(function(c) {
              self.add(c);
            });
          }
