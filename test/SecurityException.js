...
define(["ppwcode-util-contracts/doh", "../SecurityException"],
  function(doh, SecurityException) {
    ...
    doh.register("ppwcode vernacular exceptions SecurityException", [
      ...
      function testConstructor2() {
        var subject = new SecurityException({key: aKey});
        doh.invars(subject);
      ...
      function testConstructor3() {
        var subject = new SecurityException({cause: aCause});
        doh.invars(subject);
        doh.is(null, subject.key);
      ...
      function testConstructor4() {
        var subject = new SecurityException({key: aKey, cause: aCause});
        doh.invars(subject);
        doh.is(aKey, subject.key);
        doh.is(aCause, subject.cause);
      }
